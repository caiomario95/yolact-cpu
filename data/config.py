...
PELOTA_CLASSES = ('pelota')

PELOTA_LABEL_MAP = {0:1}


pelota_dataset = dataset_base.copy({
    'name': 'pelotas',

   
    'train_images': './Datasets/Pelota/train',
    'train_info':   './Datasets/Pelota/train/trainval.json',

    'valid_images': './Datasets/Pelota/val',
    'valid_info':   './Datasets/Pelota/val/val.json',


    'class_names': PELOTA_CLASSES,
    'label_map': PELOTA_LABEL_MAP
})
...
############################################
yolact_pelota_config = yolact_base_config.copy({
    'name': 'yolact_pelota', 
    
    # Dataset stuff
    'dataset': pelota_dataset,
    'num_classes': len(pelota_dataset.class_names) + 1,
    # Image Size
    'max_size': 550,
